...
if prompt == '1'
  puts "You have chosen to mutiply #{first_number} with #{second_number}"
  ...
  puts "You have chosen to find the remainder of the division of#{first_number} and the #{second_number}"
  result = multiply(first_number, second_number)
else
